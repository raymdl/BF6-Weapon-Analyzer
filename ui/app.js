...
function renderAttachmentStats(loadouts) {
  ...
  const metrics = [
    ...
    { lbl: 'ADS Spread/Shot',     val: w => w.recoilIncAds,                  unit: '°',   dec: 2, lowerBetter:  true, tooltip: 'ADS spread increase per shot after spread modifiers. Lower builds spread more slowly.' },
    { lbl: 'Hip Spread/Shot',     val: w => w.spreadDyn?.hip?.inc,           unit: '°',   dec: 2, lowerBetter:  true, tooltip: 'Hipfire spread increase per shot after spread modifiers. Lower builds spread more slowly.' },
  ...
  const estimatedFieldsForMetric = {
    ...
    'ADS Spread/Shot': ['spreadIncMult'],
    'Hip Spread/Shot': ['spreadIncMult'],
