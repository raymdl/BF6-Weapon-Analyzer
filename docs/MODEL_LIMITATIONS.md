...
include a different coefficient and additional recovery phases; these were not
promoted wholesale. Standalone light recovery remains an assumed offset boost.
...
**VSSM baseline composition.** The hip table uses explicit override index 2 instead
of raw index 4. The ordinary suppressed barrel's additional ADS tier remains a
