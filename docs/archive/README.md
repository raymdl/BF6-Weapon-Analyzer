...
Local Frosty XML exports moved to `BF6 Datamining/Frosty Exports/1.4.2.5` on 14 September 2026.
...
| [PP-19 53-round compatibility trace](PP19_53_ROUND_COMPATIBILITY_2026-09-14.md) | Implemented for all weapons by `scripts/frosty-attachment-compatibility.py`. See the [Frosty reference notes](../frosty/DATA_GRAPH.md#slots-and-prerequisites). |
