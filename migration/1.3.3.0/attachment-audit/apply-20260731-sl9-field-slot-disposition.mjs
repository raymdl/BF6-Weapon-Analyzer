...
const result = {
  ...
  sourceReceipt: 'migration/1.3.3.0/attachment-audit/sl9-detailed-recapture-20260731.json',
  groups,
  counts: { findings: findings.length, unresolved: 0, contextualValues: findings.length },
};
receipt.fieldSlotDisposition = {
  receipt: 'migration/1.3.3.0/attachment-audit/field-slot-sl9-detailed-disposition-20260731.json',
