...
const REVIEW_PATH = path.join(ROOT, 'migration', '1.3.3.0', 'attachment-audit', 'attachment-screenshot-review.json');
const RECEIPT_PATH = path.join(ROOT, 'migration', '1.3.3.0', 'attachment-audit', 'pp19-attachment-backfill-20260731.json');
...
const receipt = {
  ...
  source: {
    reviewFixture: 'migration/1.3.3.0/attachment-audit/attachment-screenshot-review.json',
