...
`scripts/audit-sweep.mjs`; its output is `migration/1.3.3.0/attachment-audit/sweep-findings.json`.
...
Verified against `migration/1.3.3.0/attachment-audit/attachment-screenshot-review.json` and against
in-game re-captures.
...
- The 27 source-backed instances live in
  `migration/1.3.3.0/attachment-audit/subsonic-velocity-treatments-20260731.json`. They do **not**
...
`migration/1.3.3.0/attachment-audit/subsonic-velocity-treatments-20260731.json`. The generic normal-ammo
...
`migration/1.3.3.0/attachment-audit/apply-20260731-open-item-fixes.mjs`. `recoilVarTierMod` does **not**
...
The completed migration witness pinned both sides of the transition for all 70,634 bounded
timing-effective cases, including the full migration diff list; that one-time witness is now
retired after the live model cutover.
...
operator receipt `migration/1.3.3.0/attachment-audit/apply-20260801-pp19-override-mag-catch-recapture.mjs`.
...
`migration/1.3.3.0/attachment-audit/model-tier-mismatch-inventory-20260801.json`.
...
Heavy Ext deferral in `BARREL_VELOCITY_PHASE7_INVENTORY.md`, not new findings. Thirty-nine are
...
materialize the report). Output: `migration/1.3.3.0/attachment-audit/sweep-findings.json`.
...
`migration/1.3.3.0/attachment-audit/bulk-suspect-recapture-summary-20260731.json` and
`migration/1.3.3.0/attachment-audit/deduped-source-record-exclusions-20260731.json`. The sweep now has no
...
5. ~~**Can recoil tier integers be sourced from Sym?**~~ **No — resolved 2026-08-01.** Sym has
   ...
   **Scoped correction and validation record — implemented 2026-08-01.** The Draw-Time migration
   ...
   1. Preserve all Draw-Time files and make no workbook rebuild or broad audit regeneration. In
      `migration/1.3.3.0/attachment-audit/attachment-screenshot-review.json`, restore all 30 stale non-None
...
migration/1.3.3.0/attachment-audit/attachment-screenshot-review.json. Records named None remain a baseline
...
migration/1.3.3.0/attachment-audit/apply-20260731-pp19-attachment-backfill.mjs and
migration/1.3.3.0/attachment-audit/verify-20260731-pp19-attachment-backfill.mjs.
