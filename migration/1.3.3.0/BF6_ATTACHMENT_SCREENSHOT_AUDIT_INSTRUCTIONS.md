...
| Artifact | Path |
|---|---|
| Review data (canonical) | `migration/1.3.3.0/attachment-audit/attachment-screenshot-review.json` |
| Schema | `schemas/attachment-screenshot-review.schema.json` |
| Coverage report | `migration/1.3.3.0/attachment-audit/coverage-report.json` |
| Rename map | `migration/1.3.3.0/attachment-audit/rename-manifest.json` |
| Comparison indicators | `migration/1.3.3.0/attachment-audit/stat-comparisons.json` |
| Raw / panel / field OCR | `migration/1.3.3.0/attachment-audit/raw-ocr.json`, `panel-ocr.json`, `field-ocr.json` |
| Manual override ledger | `migration/1.3.3.0/attachment-audit/manual-review-overrides.json` |
...
7. **Import reviewed workbook edits** with `migration/1.3.3.0/attachment-audit/import-reviewed-workbook.mjs`.
...
11. **Restore canonical numbering.** Run
    `migration/1.3.3.0/attachment-audit/apply-20260731-canonical-order-renumber.mjs`. The review builder
...
`migration/1.3.3.0/attachment-audit/apply-20260731-canonical-order-renumber.mjs` after every rebuild — it is
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File ".\scripts\extract-attachment-screenshot-ocr.ps1" `
  ...
  -OutputPath ".\migration\1.3.3.0\attachment-audit\raw-ocr.json"
```
...
`migration/1.3.3.0/attachment-audit/build-workbook.mjs`; both are prohibited for this audit.
...
The previous builder, `migration/1.3.3.0/attachment-audit/build-workbook.mjs`, is superseded. It required
...
`migration/1.3.3.0/attachment-audit/reconcile-20260728-manual-fixes.mjs`; the executable gate is
`migration/1.3.3.0/attachment-audit/verify-20260728-manual-fixes.mjs`.
...
`migration/1.3.3.0/attachment-audit/apply-20260731-missing-import-repairs.mjs`, verified by
...
Applied by `migration/1.3.3.0/attachment-audit/apply-20260731-open-item-fixes.mjs` (idempotent).
...
`migration/1.3.3.0/attachment-audit/apply-20260731-kord-shared-selector.mjs` retyped 11 KORD 6P67 records
...
`migration/1.3.3.0/attachment-audit/apply-20260731-canonical-order-renumber.mjs` changed the meaning of the
...
`migration/1.3.3.0/attachment-audit/ledger-path-drift-20260801-round2.json`, all need a judgment call
...
The idempotent passes are `migration/1.3.3.0/attachment-audit/apply-20260801-magazine-cost-corrections.mjs`,
`migration/1.3.3.0/attachment-audit/apply-20260801-tier2-magazine-costs.mjs`, and
`migration/1.3.3.0/attachment-audit/apply-20260801-ledger-path-reconciliation.mjs`, followed by
`migration/1.3.3.0/attachment-audit/apply-20260801-ledger-path-reconciliation-round2.mjs`. Evidence artifacts
are `migration/1.3.3.0/attachment-audit/tier2-20260801-magazine-cost-validation.json`,
`migration/1.3.3.0/attachment-audit/ledger-path-drift-20260801.json` and
`migration/1.3.3.0/attachment-audit/ledger-path-drift-20260801-round2.json`. Host-side finalization regenerated
...
Applied by `migration/1.3.3.0/attachment-audit/apply-20260801-ammo-stat-rule-corrections.mjs`, mirrored into
...
`migration/1.3.3.0/attachment-audit/apply-20260801-evidence-path-reconciliation.mjs`. **513 remain dead on
...
`migration/1.3.3.0/attachment-audit/apply-20260801-match-grade-subtype-rename.mjs`.
