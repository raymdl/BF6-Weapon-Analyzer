...
const PRE_PHASE3_DIGEST = 'b94f974e757b1d0ecc5fab1c904a9cfe24b423aa84b19dc42dc08dca2ce2d42c';
const PRE_PHASE4_DIGEST = '1b47edab4f05f6577825aee4ce80bbe47df00c72bff71fde0486da44f7b926d7';
const VARIANT_BASES = {
  svk86: {
...
function deployBaseIndex(weapon, modelAttachments, modelBalance) {
...
function buildEnumeration({
  ...
  for (const weapon of [...modelWeapons].sort((a, b) => a.id.localeCompare(b.id))) {
    ...
    const baseDeployIdx = deployBaseIndex(weapon, modelAttachments, modelBalance);
