...
test('Phase 4 validator rejects malformed reload shapes in an isolated data copy', () => {
  ...
  try {
    ...
    assertRejects(data => { data.WEAPON_MAG.pp19.mags['20_fast'].tacRld = 2183; }, 'suspectedGameBug is stale');
