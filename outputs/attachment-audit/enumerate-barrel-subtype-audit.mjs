...
const doc = JSON.parse(await fs.readFile(`${root}/outputs/attachment-audit/attachment-screenshot-review.json`, 'utf8'));
...
await fs.writeFile(`${root}/outputs/attachment-audit/barrel-subtype-disagreements.json`, JSON.stringify(result,null,2)+'\n');
