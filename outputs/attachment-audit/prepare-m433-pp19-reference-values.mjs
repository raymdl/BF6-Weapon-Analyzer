...
const source = JSON.parse(fs.readFileSync('outputs/attachment-audit/backups/20260724-m433-pp19-rerun/attachment-screenshot-review.pre-rerun.json', 'utf8'));
...
fs.writeFileSync('outputs/attachment-audit/reference-values-m433-pp19.json', `${JSON.stringify({ schemaVersion: 1, rows }, null, 2)}\n`);
