...
const jsonPath = process.env.BF6_ATTACHMENT_JSON_PATH ?? path.join(root, 'outputs', 'attachment-audit', 'attachment-screenshot-review.json');
const outDir = process.env.BF6_ATTACHMENT_OUTPUT_DIR ?? path.join(root, 'outputs', 'attachment-audit');
