...
const review=JSON.parse(await fs.readFile(`${root}/outputs/attachment-audit/attachment-screenshot-review.json`,'utf8'));
...
const out=`${root}/outputs/attachment-audit/previews-barrel-corrections`;await fs.mkdir(out,{recursive:true});
